...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class UnitBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (UnitNetworkObject)obj;
		...
		{
			Initialize(new UnitNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new UnitNetworkObject(networker, this, createCode, metadata);
		}
		...
		/// Vector3 position
		/// </summary>
		public abstract void MoveToPosition(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
		public abstract void OrderStop(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
